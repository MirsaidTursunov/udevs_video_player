...
struct Svg {
    ...
    static let playCircle :SVGKImage! = SVGKImage(named: "play_circle", in: Bundle(for: SwiftUdevsVideoPlayerPlugin.self), withCacheKey: nil)
    static let closeCircle :SVGKImage! = SVGKImage(named: "close_circle", in: Bundle(for: SwiftUdevsVideoPlayerPlugin.self), withCacheKey: nil)
    ...
    static let next :SVGKImage! = SVGKImage(named: "next", in: Bundle(for: SwiftUdevsVideoPlayerPlugin.self), withCacheKey: nil)
